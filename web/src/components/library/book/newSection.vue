<template>
  <div style="float:right">
    <el-button type="info" style="float:right; margin-right:5rem;"
      @click="dialogFormVisible = true">添加模块</el-button>
    <el-dialog
      title="添加模块"
      ...
      <el-form :model="form" style="text-align: left"
        ...
        <el-form-item label="简介" :label-width="formLabelWidth" prop="note">
          <el-input type="textarea" v-model="form.note" autocomplete="off" placeholder="模块简介"></el-input>
        </el-form-item>
